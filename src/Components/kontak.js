            ...
            <div className="jumbotron" >    
                ...
                <div class="p-3 mb-2 bg-dark text-center text-white lead ">Kontak</div>
                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Nomor WhatsApp saya +6281249888836</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Follow Instagram saya @ranggapas_</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card shadowss" style={{ width: "650px" }}>
                        <div class="row no-gutters">
                            <div class="col-md-4">
                                <img src="tele.jpeg" class="card-img" alt="#"></img>
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <h1 class="card-title">Telegram</h1>
                                    <p class="card-text">Nomor Telegram saya +6281249888836</p>
                                </div>
                            </div>
                        </div>
                    </div>
